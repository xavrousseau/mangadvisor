...
echo ==================================================
echo   Mangadvisor - Tests statuts bibliotheque
echo ==================================================
echo.
...
if errorlevel 1 (
    echo.
    echo ERREUR : echec des tests statuts bibliotheque.
    pause
    exit /b 1
)

echo.
echo Rapport genere dans docs\reports\library_status_tests_v0_8_5.md
echo.
pause
