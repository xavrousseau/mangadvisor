...
echo ==================================================
echo   Mangadvisor - Tests import bibliotheque
echo ==================================================
echo.
...
if errorlevel 1 (
    echo.
    echo ERREUR : echec des tests import bibliotheque.
    pause
    exit /b 1
)

echo.
echo Rapport genere dans docs\reports\library_import_tests_v0_8_10.md
echo.
pause
